...
export default function MenuiseriePage() {
  return (
    <>
      ...
      <Ouverture photo={photo("lappe-atelier")}>
        <p className="en-bref">
          <strong>En bref —</strong>{" "}
          <strong>
            La menuiserie désigne le métier de façonnage du bois en pièces d&apos;ouvrage : portes,
      ...
      <Rangee photos={galerie("menuiserie-rangee")} />

      <Suite
        blocs={[
          {
            titre: "Quels sont nos ouvrages de menuiserie phares ?",
            niveau: 2,
          ...
          {
            titre: "Pourquoi nous choisir pour vos menuiseries ?",
            niveau: 2,
          ...
          {
            id: "Portescocheres",
            titre: "Portes cochères",
            niveau: 2,
            photo: photo("perle-apres"),
            corps: (
              <>
                <p>Création et rénovation de porte cochère — travaux de réfection et de conception.</p>
                <p>
          ...
          },
          {
            ...
            corps: (
              <>
                <p>Menuiserie intérieure et extérieure — bois, aluminium, acier et PVC.</p>
                <p>
          ...
          },
          {
            ...
            titre: "Agencement",
            niveau: 2,
            photo: photo("placard-moulures"),
            corps: (
              <>
                <p>Agencement sur mesure de votre intérieur — espaces de rangement, dressings, portes intérieures moulurées.</p>
                <p>
          ...
          {
            id: "Mobiliersinterieurs",
            titre: "Mobiliers intérieurs",
            niveau: 2,
            photo: photo("banque-hotel"),
            corps: (
              <>
                <p>Création de mobiliers d&apos;intérieur — aménagez tous les mobiliers de vos envies.</p>
                <p>
          ...
          {
            id: "Amenagementsexterieurs",
            titre: "Aménagements extérieurs",
            niveau: 2,
            photo: photo("rampe-pmr"),
            corps: (
              <>
                <p>Équipez vos espaces extérieurs de pièces de menuiserie sur mesure.</p>
                <p>
          ...
          {
            titre: "Une méthode héritée, un outillage actualisé",
            niveau: 2,
      ...
      <Bande
        fond="pierre"
        surtitre="Quelques ouvrages"
        titre="Portes et façonnages récents"
        chapeau={
          <>
            D’autres ouvrages de l’atelier, datés et situés. La suite est dans{" "}
            <Link href="/photos">l’archive des ouvrages</Link>.
          </>
        }
      >
        <Galerie photos={galerie("menuiserie-fin")} />
      </Bande>

      <Questions items={MENUISERIE_FAQ} />
      ...
      <AppelContact
        surtitre="Chiffrage menuiserie"
        titre="Décrivez-nous votre projet."
        texte="Porte d'immeuble, fenêtres, agencement, mobilier — par téléphone, par courriel ou en venant nous voir à Massy. Les premiers conseils sont gratuits ; le chiffrage détaillé suit la visite sur site."
      />
    </>
  );
}
